...
to the CPU speed of the application. If the application is CPU-bound, then
...
We save around 1.25 memory accesses per packet for this application, resulting in 38\%
...
and related programming models, including Click \cite{click} and RouteBricks \cite{dobrescu2009routebricks}.
Manual optimizations to improve the performance of packet processing algorithms \cite{dobrescu2009routebricks, 189006, Kim:2012:PBC:2349896.2349910, Zhou:2013:SHP:2535372.2535379} have also been has been studied extensively.
In contrast, our work takes a compiler-centric approach to this problem, targetting micro-architectural
...
specification, most previous work involved manual optimizations for individual applications. We have already compared our work
...
specification. Unlike this previous work, our focus on network processing pipelines enables
more domain-specific optimizations, and deeper micro-architectural modeling for better performance.
